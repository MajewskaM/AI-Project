...
def load_data(source_directory):
    ...
    for filename in os.listdir(source_directory):
        ...
        if filename.endswith("x24x24.txt"):
...
dla tego Model Evaluation: accuracy: 0.8283261802575107

liczba img i doladnosc wykres!!!
...
# random state 0- i porowanieni dla roznych liczby estimators wyniki
# usunac random state


#class weight
# perceptron Model Evaluation: accuracy: 0.7587719298245614
# squared_hinge Model Evaluation: accuracy: 0.7426900584795322
# modified_huber Model Evaluation: accuracy: 0.7514619883040936
# epsilon_insensitive Model Evaluation: accuracy: 0.7646198830409356
...
#random_state=0
model = AdaBoostClassifier(estimator=sgdc, n_estimators=300, algorithm='SAMME')
# Model Evaluation: accuracy: 0.7675438596491229 n_estimators 1000 hinge
...
def evaluateResults(estimator, X_test, y_test):
    y_pred = estimator.predict(X_test)
